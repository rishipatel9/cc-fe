...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    class THREEScene {
      ...
      setup() {
        ...
        this.material = new THREE.ShaderMaterial({
          vertexShader: shaders.main.vertex,
          fragmentShader: shaders.main.fragment,
          wireframe: false,
          uniforms: {
            u_time: { value: 0 },
            u_progress: { value: 0 }
      ...
      createBackground() {
        ...
        this.backgroundMaterial = new THREE.ShaderMaterial({
          vertexShader: shaders.background.vertex,
          fragmentShader: shaders.background.fragment,
          wireframe: false,
          uniforms: {
            u_time: { value: 0 },
            u_progress: { value: 0 }
      ...
      render = () => {
        ...
        this.pointsMaterial.uniforms.u_time.value = elapsedTime;
    ...
    sceneRef.current = new THREEScene(container);
